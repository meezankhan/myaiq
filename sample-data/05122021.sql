...
INSERT INTO `homepagemaster` VALUES (1,1,'ASGR','CMT','CMT','BANK OF IRELAND','yannick.sadowy','tarandeep.s.chandhok','rohit.kumar.bansal.h@accenture.com',3),(2,1,'GALLIA','FS','FS','BP','aliette.leleux','rajendra.joshi','samir.pandey@accenture.com',5),(3,1,'Interactive','H&PS','H&PS','BP','aliette.leleux','balaji.venkataraman','amita.a.gupta@accenture.com',6),(4,1,'Interactive','PRD','PRD','H&M','cora.stone','rajendra.joshi','sajith.k.malayath@accenture.com',13),(5,1,'Horizontal','PRD','PRD','BANK OF IRELAND','yannick.sadowy','manoj.sudhakar','praveen.k.sharma@accenture.com',3),(6,1,'GALLIA','RES','RES','FIAT','cora.stone','anoop.g.jain','senthil.palanichamy@accenture.com',13),(7,1,'NII','FS','FS','FIAT','patrick.slattery','Mallikarjun.SB','sanket.ladda@accenture.com',12),(8,1,'GALLIA','H&PS','H&PS','BP','cora.stone','rajendra.joshi','shilpi.h.jain@accenture.com',13),(9,1,'Interactive','FS','FS','FIAT','patrick','Rajendra','ajay@accenture.com',13);
...
CREATE TABLE `recommendations` (
  ...
  `innovationparamid` int NOT NULL,
  PRIMARY KEY (`id`),
  KEY `innoParamId_fk_idx` (`innovationparamid`),
  CONSTRAINT `innoParamId_fk` FOREIGN KEY (`innovationparamid`) REFERENCES `innovationparammaster` (`id`)
...
INSERT INTO `recommendations` VALUES (1,'NOVICE','attend training',NULL,1);
...
INSERT INTO `surveymaster` VALUES (1,'Innovation Questionaire',1.0,99,9);
...
INSERT INTO `surveyresult` VALUES (14,5,13,1,'Interactive','PRD','PRD','H&M','cora.stone','rajendra.joshi','sajith.k.malayath@accenture.com','SUBMITTED',32,NULL,'2021-04-30 16:37:35'),(15,5,13,1,'Interactive','PRD','PRD','FIAT','cora.stone','rajendra.joshi','sajith.k.malayath@accenture.com','IN PROGRESS',32,'2021-04-30 16:45:41','2021-04-30 16:45:41'),(16,1,3,1,'ASGR','CMT','CMT','BANK OF IRELAND','yannick.sadowy','tarandeep.s.chandhok','rohit.kumar.bansal.h@accenture.com','IN PROGRESS',24,'2021-04-30 16:45:41','2021-04-30 16:45:41'),(17,2,12,1,'Interactive','FS','FS','FIAT','yannick.sadowy','tarandeep.s.chandhok','rohit.kumar.bansal.h@accenture.com','IN PROGRESS',36,'2021-04-30 16:45:41','2021-04-30 16:45:41');
...
INSERT INTO `usermaster` VALUES (1,'rohit.kumar.bansal.h@accenture.com','User','',1),(2,'samir.pandey@accenture.com','MU Lead','GALLIA',1),(3,'senthil.palanichamy@accenture.com','Super Admin','ALL',1),(4,'sanket.ladda@accenture.com','User','NII',1),(5,'sajith.k.malayath@accenture.com','User','',1),(6,'amita.a.gupta@accenture.com','MU Lead','Interactive',1),(7,'praveen.k.sharma@accenture.com','User','Horizontal',1),(8,'shilpi.h.jain@accenture.com','User','GALLIA',1);
...
INSERT INTO `userprojectmapping` VALUES (1,1,3),(2,1,5),(3,2,13),(4,4,12),(5,5,13),(6,6,6),(7,7,3),(8,8,13);
...
-- Dump completed on 2021-05-12 17:54:37
