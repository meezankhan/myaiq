export function getFormData(userDetails) {

let url;
if(userDetails){
  url = `http://localhost:8081/survey/resume/${userDetails.surveyId}/${userDetails.projectId}`;
}else{
  url = `http://localhost:8081/survey/start/1/5`;
}
